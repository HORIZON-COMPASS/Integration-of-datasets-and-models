...
## and also do it for the aggregated files from script 6
    filename="${output_dir}/step_3/emo_data/EFAS_converted/${var}_1994.nc"  #Take any one sample year from EMO-1 to use it for a single year (for example: 1994 is taken here)
...
# Set files
    tas="${output_dir}/step_3/emo_data/EFAS_converted/tas_1994.nc" #Take any one sample year from EMO-1 to use it for a single year (for example: 1994 is taken here)
    tn="${output_dir}/step_3/emo_data/EFAS_converted/tasmin_1994.nc"
    tx="${output_dir}/step_3/emo_data/EFAS_converted/tasmax_1994.nc"
    tasrange="${output_dir}/step_3/emo_data/EFAS_converted/tasrange_1994.nc"
    tasskew="${output_dir}/step_3/emo_data/EFAS_converted/tasskew_1994.nc"
